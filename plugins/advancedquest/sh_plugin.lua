...
GLOBAL_PreDefinedDialogue = {
	...
	["safebox"] = {
		["Button"] = "Can I upgrade my storage?",
		["Response"] = [[ Yeah sure. I just need some payment for it to get it all organised. It will be around 250 thrones.
		]],
		["Callback"] = false,
		["Additional"] = {
			["Payment"] = {
				["Button"] = "Sure here is the cash for the storage space",
				["Response"] = [[Good then. I sent some lads over and they should have gotten some more space sorted for you. ]]
			}
		}
	},
